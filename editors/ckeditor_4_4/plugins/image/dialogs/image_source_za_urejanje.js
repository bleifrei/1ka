						...
						children: [
							...
							children: [
								...
								onChange: function() {
                                 ...
                                 //custom funkcija za urlsrc-> ko naložimo sliko, da prilepi url.
                                 onLoad: function() {
                                  urlsrc=this.getDialog().getContentElement('info', 'txtUrl').getInputElement().getId();
                                 },
							...
							children: [
								...
								html: '<div>' + CKEDITOR.tools.htmlEncode( editor.lang.common.preview ) + '<br>' +
									...
									'<div class="ImagePreviewBox"><table><tr><td>' +
										...
										( editor.config.image_previewText || 'Predogled slike.') +
									'</td></tr></table></div></div>'
								}
							]
						}
