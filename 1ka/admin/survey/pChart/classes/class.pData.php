 ...
 class pData
  {
   ...
   function SetAbsciseLabelSerie($SerieName = "Name")
	...
	// nastavimo desno serijo (za semanticni diferencial)
	function SetRightLabelSerie($SerieName = "Name")
    {
     $this->DataDescription["Right"] = $SerieName;
    }
